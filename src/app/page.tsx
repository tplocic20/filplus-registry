          ...
          <div className="flex items-center space-x-4">
            ...
            >
              ...
              <SelectContent>
                ...
                <SelectItem value="AdditionalInfoSubmitted">Additional Info Submitted</SelectItem>
                <SelectItem value="AdditionalInfoRequired">Additional Info Required</SelectItem>
              </SelectContent>
            </Select>
