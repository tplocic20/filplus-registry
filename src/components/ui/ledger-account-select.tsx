...
const AccountSelectionDialog: React.FC<AccountSelectionDialogProps> = ({ open, accounts, onClose, onSelect }) => {
        ...
        <Table>
          <TableBody>
            {accounts.map((account, index) => (
              <StyledTableRow key={account} hover onClick={() => handleListItemClick(index)}>
